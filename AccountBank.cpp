...
std::variant<AccountBank::ResultWithdraw, double> AccountBank::withdraw(const double amount) {
    if (amount < 0)
        return NEGATIVE;
...
std::variant<AccountBank::ResultWithdraw, double> AccountBank::withdrawPlusRate(const double &amount) {
